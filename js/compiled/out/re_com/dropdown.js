...
if(cljs.core.truth_((function (){var and__26894__auto__ = new_index;
...
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"group","group",582596132)],[cljs.core.gensym.call(null),p1__34299_SHARP_]);
});})(groups))
...
var or__26906__auto__ = re__$1.test(group_fn.call(null,opt));
...
var new_scroll_top = (((item_offset_bottom > parent_visible_bottom))?(function (){var x__27237__auto__ = (item_offset_bottom - parent_height);
var y__27238__auto__ = (0);
 ...
 */
re_com.dropdown.filter_text_box = cljs.core.with_meta.call(null,re_com.dropdown.filter_text_box_base,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"component-did-mount","component-did-mount",-1126910518),(function (p1__34302_SHARP_){
var node = reagent.core.dom_node.call(null,p1__34302_SHARP_).firstChild;
return node.focus();
}),new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),(function (p1__34303_SHARP_){
var node = reagent.core.dom_node.call(null,p1__34303_SHARP_).firstChild;
return node.focus();
})], null));
/**
...
var len__27981__auto___34318 = arguments.length;
var i__27982__auto___34319 = (0);
while(true){
if((i__27982__auto___34319 < len__27981__auto___34318)){
args__27988__auto__.push((arguments[i__27982__auto___34319]));

var G__34320 = (i__27982__auto___34319 + (1));
i__27982__auto___34319 = G__34320;
continue;
} else {
}
break;
...
return re_com.dropdown.single_dropdown.cljs$core$IFn$_invoke$arity$variadic(argseq__27989__auto__);
});

re_com.dropdown.single_dropdown.cljs$core$IFn$_invoke$arity$variadic = (function (p__34308){
...
var args = map__34309__$1;
var model = cljs.core.get.call(null,map__34309__$1,new cljs.core.Keyword(null,"model","model",331153215));
...
return ((function (external_model,internal_model,drop_showing_QMARK_,filter_text,map__34309,map__34309__$1,args,model){
return (function() { 
var G__34321__delegate = function (p__34311){
...
var args__$1 = map__34312__$1;
var group_fn = cljs.core.get.call(null,map__34312__$1,new cljs.core.Keyword(null,"group-fn","group-fn",129203707),new cljs.core.Keyword(null,"group","group",582596132));
var disabled_QMARK_ = cljs.core.get.call(null,map__34312__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__34312__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var model__$1 = cljs.core.get.call(null,map__34312__$1,new cljs.core.Keyword(null,"model","model",331153215));
var attr = cljs.core.get.call(null,map__34312__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var label_fn = cljs.core.get.call(null,map__34312__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263),new cljs.core.Keyword(null,"label","label",1718410804));
var tab_index = cljs.core.get.call(null,map__34312__$1,new cljs.core.Keyword(null,"tab-index","tab-index",895755393));
var max_height = cljs.core.get.call(null,map__34312__$1,new cljs.core.Keyword(null,"max-height","max-height",-612563804));
var placeholder = cljs.core.get.call(null,map__34312__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
var title_QMARK_ = cljs.core.get.call(null,map__34312__$1,new cljs.core.Keyword(null,"title?","title?",-1510254555));
var render_fn = cljs.core.get.call(null,map__34312__$1,new cljs.core.Keyword(null,"render-fn","render-fn",398796518),label_fn);
var width = cljs.core.get.call(null,map__34312__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var regex_filter_QMARK_ = cljs.core.get.call(null,map__34312__$1,new cljs.core.Keyword(null,"regex-filter?","regex-filter?",-824895668));
var choices = cljs.core.get.call(null,map__34312__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.call(null,map__34312__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798),new cljs.core.Keyword(null,"id","id",-1388402092));
var style = cljs.core.get.call(null,map__34312__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var class$ = cljs.core.get.call(null,map__34312__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var filter_box_QMARK_ = cljs.core.get.call(null,map__34312__$1,new cljs.core.Keyword(null,"filter-box?","filter-box?",-1157583688));
...
:null);
var changeable_QMARK_ = (function (){var and__26894__auto__ = on_change;
if(cljs.core.truth_(and__26894__auto__)){
...
var callback = ((function (choices__$1,disabled_QMARK___$1,regex_filter_QMARK___$1,latest_ext_model,_,changeable_QMARK_,map__34312,map__34312__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK_,choices,id_fn,style,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,map__34309,map__34309__$1,args,model){
return (function (p1__34304_SHARP_){
cljs.core.reset_BANG_.call(null,internal_model,p1__34304_SHARP_);

if(cljs.core.truth_((function (){var and__26894__auto__ = changeable_QMARK_;
if(cljs.core.truth_(and__26894__auto__)){
...
});})(choices__$1,disabled_QMARK___$1,regex_filter_QMARK___$1,latest_ext_model,_,changeable_QMARK_,map__34312,map__34312__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK_,choices,id_fn,style,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,map__34309,map__34309__$1,args,model))
;
var cancel = ((function (choices__$1,disabled_QMARK___$1,regex_filter_QMARK___$1,latest_ext_model,_,changeable_QMARK_,callback,map__34312,map__34312__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK_,choices,id_fn,style,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,map__34309,map__34309__$1,args,model){
return (function (){
cljs.core.reset_BANG_.call(null,drop_showing_QMARK_,false);
...
});})(choices__$1,disabled_QMARK___$1,regex_filter_QMARK___$1,latest_ext_model,_,changeable_QMARK_,callback,map__34312,map__34312__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK_,choices,id_fn,style,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,map__34309,map__34309__$1,args,model))
;
var dropdown_click = ((function (choices__$1,disabled_QMARK___$1,regex_filter_QMARK___$1,latest_ext_model,_,changeable_QMARK_,callback,cancel,map__34312,map__34312__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK_,choices,id_fn,style,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,map__34309,map__34309__$1,args,model){
return (function (){
...
;
var press_end = ((function (choices__$1,disabled_QMARK___$1,regex_filter_QMARK___$1,latest_ext_model,_,changeable_QMARK_,callback,cancel,dropdown_click,filtered_choices,press_enter,press_escape,press_tab,press_up,press_down,press_home,map__34312,map__34312__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK_,choices,id_fn,style,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,map__34309,map__34309__$1,args,model){
return (function (){
...
;
var key_handler = ((function (choices__$1,disabled_QMARK___$1,regex_filter_QMARK___$1,latest_ext_model,_,changeable_QMARK_,callback,cancel,dropdown_click,filtered_choices,press_enter,press_escape,press_tab,press_up,press_down,press_home,press_end,map__34312,map__34312__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK_,choices,id_fn,style,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,map__34309,map__34309__$1,args,model){
return (function (p1__34305_SHARP_){
if(cljs.core.truth_(disabled_QMARK___$1)){
return false;
} else {
var G__34314 = p1__34305_SHARP_.which;
switch (G__34314) {
case (13):
...
while (G__34323__i < G__34323__a.length) {G__34323__a[G__34323__i] = arguments[G__34323__i + 0]; ++G__34323__i;}
  p__34311 = new cljs.core.IndexedSeq(G__34323__a,0);
} 
return G__34321__delegate.call(this,p__34311);};
G__34321.cljs$lang$maxFixedArity = 0;
G__34321.cljs$lang$applyTo = (function (arglist__34324){
var p__34311 = cljs.core.seq(arglist__34324);
return G__34321__delegate(p__34311);
});
G__34321.cljs$core$IFn$_invoke$arity$variadic = G__34321__delegate;
return G__34321;
})()
;
;})(external_model,internal_model,drop_showing_QMARK_,filter_text,map__34309,map__34309__$1,args,model))
});

re_com.dropdown.single_dropdown.cljs$lang$maxFixedArity = (0);

re_com.dropdown.single_dropdown.cljs$lang$applyTo = (function (seq34307){
return re_com.dropdown.single_dropdown.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq34307));
});


//# sourceMappingURL=dropdown.js.map?rel=1506566551770