...
var args34269 = [];
var len__27981__auto___34272 = arguments.length;
var i__27982__auto___34273 = (0);
while(true){
if((i__27982__auto___34273 < len__27981__auto___34272)){
args34269.push((arguments[i__27982__auto___34273]));

var G__34274 = (i__27982__auto___34273 + (1));
i__27982__auto___34273 = G__34274;
continue;
} else {
}
break;
...
var base_style__$1 = (cljs.core.truth_((function (){var and__26894__auto__ = selected_QMARK_;
...
var base_style__$2 = (cljs.core.truth_((function (){var and__26894__auto__ = selected_QMARK_;
if(cljs.core.truth_(and__26894__auto__)){
...
if(cljs.core.truth_((function (){var and__26894__auto__ = required_QMARK_;
if(cljs.core.truth_(and__26894__auto__)){
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__34279){
var map__34282 = p__34279;
...
var args = map__34282__$1;
var disabled_QMARK_ = cljs.core.get.call(null,map__34282__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__34282__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var item_renderer = cljs.core.get.call(null,map__34282__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.call(null,map__34282__$1,new cljs.core.Keyword(null,"model","model",331153215));
var label_fn = cljs.core.get.call(null,map__34282__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.call(null,map__34282__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.call(null,map__34282__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var hide_border_QMARK_ = cljs.core.get.call(null,map__34282__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var choices = cljs.core.get.call(null,map__34282__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.call(null,map__34282__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798));
var multi_select_QMARK_ = cljs.core.get.call(null,map__34282__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.call(null,(cljs.core.truth_(item_renderer)?((function (selected,map__34282,map__34282__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__34276_SHARP_){
return item_renderer.call(null,p1__34276_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__34282,map__34282__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__34282,map__34282__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__34277_SHARP_){
return re_com.selection_list.as_checked.call(null,p1__34277_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__34282,map__34282__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:((function (selected,map__34282,map__34282__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__34278_SHARP_){
return re_com.selection_list.as_radio.call(null,p1__34278_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__34282,map__34282__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
)),choices);
...
var len__27981__auto___34291 = arguments.length;
var i__27982__auto___34292 = (0);
while(true){
if((i__27982__auto___34292 < len__27981__auto___34291)){
args__27988__auto__.push((arguments[i__27982__auto___34292]));

var G__34293 = (i__27982__auto___34292 + (1));
i__27982__auto___34292 = G__34293;
continue;
} else {
}
break;
...
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(argseq__27989__auto__);
});

re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__34285){
...
var args = map__34286__$1;
if(cljs.core.truth_(((!(goog.DEBUG))?true:re_com.validate.validate_args.call(null,re_com.validate.extract_arg_data.call(null,re_com.selection_list.selection_list_args_desc),args,"selection-list")))){
} else {
throw (new Error("Assert failed: (validate-args-macro selection-list-args-desc args \"selection-list\")"));
}

return ((function (map__34286,map__34286__$1,args){
return (function() { 
var G__34294__delegate = function (p__34288){
...
while (G__34295__i < G__34295__a.length) {G__34295__a[G__34295__i] = arguments[G__34295__i + 0]; ++G__34295__i;}
  p__34288 = new cljs.core.IndexedSeq(G__34295__a,0);
} 
return G__34294__delegate.call(this,p__34288);};
G__34294.cljs$lang$maxFixedArity = 0;
G__34294.cljs$lang$applyTo = (function (arglist__34296){
var p__34288 = cljs.core.seq(arglist__34296);
return G__34294__delegate(p__34288);
});
G__34294.cljs$core$IFn$_invoke$arity$variadic = G__34294__delegate;
return G__34294;
})()
;
;})(map__34286,map__34286__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq34284){
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq34284));
});


//# sourceMappingURL=selection_list.js.map?rel=1506566551481