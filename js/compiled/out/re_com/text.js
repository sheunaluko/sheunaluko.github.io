...
var len__27981__auto___29176 = arguments.length;
var i__27982__auto___29177 = (0);
while(true){
if((i__27982__auto___29177 < len__27981__auto___29176)){
args__27988__auto__.push((arguments[i__27982__auto___29177]));

var G__29178 = (i__27982__auto___29177 + (1));
i__27982__auto___29177 = G__29178;
continue;
} else {
}
break;
...
return re_com.text.label.cljs$core$IFn$_invoke$arity$variadic(argseq__27989__auto__);
});

re_com.text.label.cljs$core$IFn$_invoke$arity$variadic = (function (p__29173){
...
var args = map__29174__$1;
var label = cljs.core.get.call(null,map__29174__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var on_click = cljs.core.get.call(null,map__29174__$1,new cljs.core.Keyword(null,"on-click","on-click",1632826543));
var width = cljs.core.get.call(null,map__29174__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var class$ = cljs.core.get.call(null,map__29174__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var style = cljs.core.get.call(null,map__29174__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var attr = cljs.core.get.call(null,map__29174__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
...
var args__27988__auto__ = [];
var len__27981__auto___29183 = arguments.length;
var i__27982__auto___29184 = (0);
while(true){
if((i__27982__auto___29184 < len__27981__auto___29183)){
args__27988__auto__.push((arguments[i__27982__auto___29184]));

var G__29185 = (i__27982__auto___29184 + (1));
i__27982__auto___29184 = G__29185;
continue;
} else {
}
break;
...
var argseq__27989__auto__ = ((((0) < args__27988__auto__.length))?(new cljs.core.IndexedSeq(args__27988__auto__.slice((0)),(0),null)):null);
return re_com.text.title.cljs$core$IFn$_invoke$arity$variadic(argseq__27989__auto__);
});

re_com.text.title.cljs$core$IFn$_invoke$arity$variadic = (function (p__29180){
...
var args = map__29181__$1;
var label = cljs.core.get.call(null,map__29181__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var level = cljs.core.get.call(null,map__29181__$1,new cljs.core.Keyword(null,"level","level",1290497552));
var underline_QMARK_ = cljs.core.get.call(null,map__29181__$1,new cljs.core.Keyword(null,"underline?","underline?",-1123247603));
var margin_top = cljs.core.get.call(null,map__29181__$1,new cljs.core.Keyword(null,"margin-top","margin-top",392161226),"0.6em");
var margin_bottom = cljs.core.get.call(null,map__29181__$1,new cljs.core.Keyword(null,"margin-bottom","margin-bottom",388334941),"0.3em");
var class$ = cljs.core.get.call(null,map__29181__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var style = cljs.core.get.call(null,map__29181__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var attr = cljs.core.get.call(null,map__29181__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
...
re_com.text.title.cljs$lang$applyTo = (function (seq29179){
return re_com.text.title.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq29179));
});
...
var args__27988__auto__ = [];
var len__27981__auto___29190 = arguments.length;
var i__27982__auto___29191 = (0);
while(true){
if((i__27982__auto___29191 < len__27981__auto___29190)){
args__27988__auto__.push((arguments[i__27982__auto___29191]));

var G__29192 = (i__27982__auto___29191 + (1));
i__27982__auto___29191 = G__29192;
continue;
} else {
}
break;
...
var argseq__27989__auto__ = ((((0) < args__27988__auto__.length))?(new cljs.core.IndexedSeq(args__27988__auto__.slice((0)),(0),null)):null);
return re_com.text.p.cljs$core$IFn$_invoke$arity$variadic(argseq__27989__auto__);
});

re_com.text.p.cljs$core$IFn$_invoke$arity$variadic = (function (children){
var child1 = cljs.core.first.call(null,children);
var vec__29187 = ((cljs.core.map_QMARK_.call(null,child1))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [child1,cljs.core.rest.call(null,children)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.PersistentArrayMap.EMPTY,children], null));
var m = cljs.core.nth.call(null,vec__29187,(0),null);
var children__$1 = cljs.core.nth.call(null,vec__29187,(1),null);
...
re_com.text.p.cljs$lang$applyTo = (function (seq29186){
return re_com.text.p.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq29186));
});


//# sourceMappingURL=text.js.map?rel=1506566544702