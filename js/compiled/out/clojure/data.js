...
return cljs.core.reduce.call(null,(function (result,p__42858){
var vec__42859 = p__42858;
var k = cljs.core.nth.call(null,vec__42859,(0),null);
var v = cljs.core.nth.call(null,vec__42859,(1),null);
...
var vec__42865 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__42865,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__42865,(1),null);
var ab = cljs.core.nth.call(null,vec__42865,(2),null);
...
var args42868 = [];
var len__27981__auto___42871 = arguments.length;
var i__27982__auto___42872 = (0);
while(true){
if((i__27982__auto___42872 < len__27981__auto___42871)){
args42868.push((arguments[i__27982__auto___42872]));

var G__42873 = (i__27982__auto___42872 + (1));
i__27982__auto___42872 = G__42873;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args42868.length)].join('')));
...
var x__27569__auto__ = (((x == null))?null:x);
var m__27570__auto__ = (clojure.data.equality_partition[goog.typeOf(x__27569__auto__)]);
if(!((m__27570__auto__ == null))){
return m__27570__auto__.call(null,x);
} else {
var m__27570__auto____$1 = (clojure.data.equality_partition["_"]);
if(!((m__27570__auto____$1 == null))){
return m__27570__auto____$1.call(null,x);
} else {
...
var x__27569__auto__ = (((a == null))?null:a);
var m__27570__auto__ = (clojure.data.diff_similar[goog.typeOf(x__27569__auto__)]);
if(!((m__27570__auto__ == null))){
return m__27570__auto__.call(null,a,b);
} else {
var m__27570__auto____$1 = (clojure.data.diff_similar["_"]);
if(!((m__27570__auto____$1 == null))){
return m__27570__auto____$1.call(null,a,b);
} else {
...
return (function (){var G__42878 = (((clojure.data.equality_partition.call(null,a) instanceof cljs.core.Keyword))?clojure.data.equality_partition.call(null,a).fqn:null);
switch (G__42878) {
case "atom":
...
//# sourceMappingURL=data.js.map?rel=1506566569358