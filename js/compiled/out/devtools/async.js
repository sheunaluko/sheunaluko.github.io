...
var o__40691__auto___43884 = (function (){var o__40691__auto__ = (function (){var o__40691__auto__ = Promise;
return goog.object.get(o__40691__auto__,"resolve").call(o__40691__auto__);
})();
return goog.object.get(o__40691__auto__,"then").call(o__40691__auto__,callback);
})();
goog.object.get(o__40691__auto___43884,"catch").call(o__40691__auto___43884,devtools.async.rethrow_outside_promise);
...
var G__43886_43887 = Error;
var target__40710__auto___43888 = G__43886_43887;
if(cljs.core.truth_(target__40710__auto___43888)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("unable to locate object path "),cljs.core.str(null),cljs.core.str(" in "),cljs.core.str(G__43886_43887)].join('')),cljs.core.str("\n"),cljs.core.str("target__40710__auto__")].join('')));
}

goog.object.set(target__40710__auto___43888,cljs.core.last.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["stackTraceLimit"], null)),Infinity);
...
//# sourceMappingURL=async.js.map?rel=1506566572068