...
var len__27981__auto___43153 = arguments.length;
var i__27982__auto___43154 = (0);
while(true){
if((i__27982__auto___43154 < len__27981__auto___43153)){
args__27988__auto__.push((arguments[i__27982__auto___43154]));

var G__43155 = (i__27982__auto___43154 + (1));
i__27982__auto___43154 = G__43155;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__27989__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq43150){
var G__43151 = cljs.core.first.call(null,seq43150);
var seq43150__$1 = cljs.core.next.call(null,seq43150);
var G__43152 = cljs.core.first.call(null,seq43150__$1);
var seq43150__$2 = cljs.core.next.call(null,seq43150__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__43151,G__43152,seq43150__$2);
});
...
if(cljs.core.truth_((function (){var or__26906__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__27512__auto__,writer__27513__auto__,opt__27514__auto__){
return cljs.core._write.call(null,writer__27513__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__26894__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__26894__auto__){
var or__26906__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__26906__auto__)){
return or__26906__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__43156_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__43156_SHARP_));
})))){
...
var markup_db = cljs.core.get.call(null,map__43165__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__26906__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e43169){var e__40716__auto__ = e43169;
return false;
}})();
if(cljs.core.truth_(or__26906__auto__)){
return or__26906__auto__;
...
}catch (e43171){var e__40716__auto__ = e43171;
return false;
}}
})())){
...
var _STAR_current_state_STAR_43176 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__43177 = opts;
...
var markup_db = cljs.core.get.call(null,map__43177__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_43176;
}});
...
;
var temp__4655__auto___43182 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___43182)){
var managed_print_level_43183 = temp__4655__auto___43182;
var _STAR_print_level_STAR_43181_43184 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_43183;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_43181_43184,managed_print_level_43183,temp__4655__auto___43182,writer,opts,job_fn){
return (function (p1__43179_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__43179_SHARP_,null);
});})(_STAR_print_level_STAR_43181_43184,managed_print_level_43183,temp__4655__auto___43182,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_43181_43184;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1506566570396