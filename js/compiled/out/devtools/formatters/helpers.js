...
var G__43112 = devtools.prefs.pref.call(null,v);
v = G__43112;
continue;
} else {
return v;
...
var and__26894__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__26894__auto__){
var and__26894__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__26906__auto__ = (function (){try{if(!((value == null))){
...
}catch (e43125){var e__40716__auto__ = e43125;
return false;
}})();
if(cljs.core.truth_(or__26906__auto__)){
return or__26906__auto__;
} else {
var or__26906__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e43129){var e__40716__auto__ = e43129;
return false;
}})();
...
}catch (e43131){var e__40716__auto__ = e43131;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__26894__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__26894__auto__)){
var and__26894__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__26894__auto____$1){
...
var and__26894__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__26894__auto__)){
...
var or__26906__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__26906__auto__)){
return or__26906__auto__;
} else {
...
var and__26894__auto__ = (function (){var or__26906__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__26906__auto__)){
return or__26906__auto__;
} else {
...
var vec__43136 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__43136,(0),null);
var name = cljs.core.nth.call(null,vec__43136,(1),null);
...
var and__26894__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__26894__auto__)){
...
var or__26906__auto__ = typeof value === 'string';
if(or__26906__auto__){
return or__26906__auto__;
} else {
var or__26906__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__43139_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__43139_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1506566570159