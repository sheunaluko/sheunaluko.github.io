...
var len__27981__auto___43144 = arguments.length;
var i__27982__auto___43145 = (0);
while(true){
if((i__27982__auto___43145 < len__27981__auto___43144)){
args__27988__auto__.push((arguments[i__27982__auto___43145]));

var G__43146 = (i__27982__auto___43145 + (1));
i__27982__auto___43145 = G__43146;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__27989__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq43142){
var G__43143 = cljs.core.first.call(null,seq43142);
var seq43142__$1 = cljs.core.next.call(null,seq43142);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__43143,seq43142__$1);
});
...
return (p1__43147_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1506566570231