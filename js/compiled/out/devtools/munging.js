...
var o__40691__auto__ = (function (){var temp__4657__auto__ = goog.object.get(window,"cljs");
if(cljs.core.truth_(temp__4657__auto__)){
var o__40703__auto__ = temp__4657__auto__;
return goog.object.get(o__40703__auto__,"core");
} else {
return null;
}
})();
return goog.object.get(o__40691__auto__,"js_reserved_QMARK_").call(o__40691__auto__,x);
});
devtools.munging.get_fn_source_safely = (function devtools$munging$get_fn_source_safely(f){
try{var o__40691__auto__ = f;
return goog.object.get(o__40691__auto__,"toString").call(o__40691__auto__);
...
try{var o__40691__auto___42969 = t;
goog.object.get(o__40691__auto___42969,"cljs$lang$ctorPrWriter").call(o__40691__auto___42969,t,writer);
}catch (e42968){var __42970 = e42968;
}
...
var char_code = (function (){var o__40691__auto__ = (new String(char$));
return goog.object.get(o__40691__auto__,"charCodeAt").call(o__40691__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__40691__auto__ = String;
return goog.object.get(o__40691__auto__,"fromCharCode").call(o__40691__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__42972 = num_code;
switch (G__42972) {
case (1):
return (185);
...
var o__40691__auto__ = String;
return goog.object.get(o__40691__auto__,"fromCharCode").call(o__40691__auto__,superscript_code);
});
/**
...
}catch (e42978){var e__40716__auto__ = e42978;
return false;
}})())){
...
var vec__42979 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__42979,(0),null);
...
var or__26906__auto__ = (function (){var temp__4655__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__4655__auto__)){
...
var temp__4657__auto____$1 = goog.object.get(o__40704__auto__,"dependencies_");
if(cljs.core.truth_(temp__4657__auto____$1)){
var o__40703__auto__ = temp__4657__auto____$1;
return goog.object.get(o__40703__auto__,"nameToPath");
} else {
return null;
}
} else {
...
var len__27981__auto___42988 = arguments.length;
var i__27982__auto___42989 = (0);
while(true){
if((i__27982__auto___42989 < len__27981__auto___42988)){
args__27988__auto__.push((arguments[i__27982__auto___42989]));

var G__42990 = (i__27982__auto___42989 + (1));
i__27982__auto___42989 = G__42990;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__27989__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__42984){
var vec__42985 = p__42984;
var ns_detector = cljs.core.nth.call(null,vec__42985,(0),null);
var effective_detector = (function (){var or__26906__auto__ = ns_detector;
if(cljs.core.truth_(or__26906__auto__)){
return or__26906__auto__;
} else {
...
var G__42991 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__42992 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__42991;
remaining_tokens = G__42992;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq42982){
var G__42983 = cljs.core.first.call(null,seq42982);
var seq42982__$1 = cljs.core.next.call(null,seq42982);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__42983,seq42982__$1);
});
...
break;
default:
var o__40691__auto__ = window;
return goog.object.get(o__40691__auto__,"parseInt").call(o__40691__auto__,arity,(10));
...
var vec__43000 = cljs.core.split_with.call(null,(function (p1__42996_SHARP_){
return cljs.core.not_EQ_.call(null,p1__42996_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__43000,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__43000,(1),null);
...
var vec__43006 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__43006,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__43006,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__43009 = cljs.core.rest.call(null,remaining_tokens);
var G__43010 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__43009;
name_tokens = G__43010;
continue;
} else {
...
var args43011 = [];
var len__27981__auto___43023 = arguments.length;
var i__27982__auto___43024 = (0);
while(true){
if((i__27982__auto___43024 < len__27981__auto___43023)){
args43011.push((arguments[i__27982__auto___43024]));

var G__43025 = (i__27982__auto___43024 + (1));
i__27982__auto___43024 = G__43025;
continue;
} else {
}
break;
...
var vec__43014 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__43014,(0),null);
var arity = cljs.core.nth.call(null,vec__43014,(1),null);
var vec__43017 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__43017,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__43017,(1),null);
var vec__43020 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__43020,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__43020,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__43020,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__43020,(3),null);
...
var args43027 = [];
var len__27981__auto___43033 = arguments.length;
var i__27982__auto___43034 = (0);
while(true){
if((i__27982__auto___43034 < len__27981__auto___43033)){
args43027.push((arguments[i__27982__auto___43034]));

var G__43035 = (i__27982__auto___43034 + (1));
i__27982__auto___43034 = G__43035;
continue;
} else {
}
break;
...
var vec__43030 = result;
var munged_ns = cljs.core.nth.call(null,vec__43030,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__43030,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__43030,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__43030,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__43030,(4),null);
var arity = cljs.core.nth.call(null,vec__43030,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__43043 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__43043,(0),null);
var args = cljs.core.nth.call(null,vec__43043,(1),null);
var vec__43046 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__43046,(0),null);
var name = cljs.core.nth.call(null,vec__43046,(1),null);
...
var G__43049 = (arity + (1));
var G__43050 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__43051){
var vec__43055 = p__43051;
var arity = cljs.core.nth.call(null,vec__43055,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__43055,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__26906__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__26906__auto__)){
return or__26906__auto__;
} else {
...
return (function (p1__43058_SHARP_){
return cljs.core.get.call(null,arities,p1__43058_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__43059_SHARP_);
...
var args__27988__auto__ = [];
var len__27981__auto___43066 = arguments.length;
var i__27982__auto___43067 = (0);
while(true){
if((i__27982__auto___43067 < len__27981__auto___43066)){
args__27988__auto__.push((arguments[i__27982__auto___43067]));

var G__43068 = (i__27982__auto___43067 + (1));
i__27982__auto___43067 = G__43068;
continue;
} else {
}
break;
...
var argseq__27989__auto__ = ((((1) < args__27988__auto__.length))?(new cljs.core.IndexedSeq(args__27988__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__27989__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__43062){
var vec__43063 = p__43062;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__43063,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq43060){
var G__43061 = cljs.core.first.call(null,seq43060);
var seq43060__$1 = cljs.core.next.call(null,seq43060);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__43061,seq43060__$1);
});
...
var G__43070 = (((arg instanceof cljs.core.Keyword))?arg.fqn:null);
switch (G__43070) {
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__26906__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__26906__auto__)){
return or__26906__auto__;
} else {
...
return [cljs.core.str((cljs.core.truth_((function (){var and__26894__auto__ = include_ns_QMARK_;
...
return [cljs.core.str((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str(protocol_name)].join(''):null)),cljs.core.str(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str((cljs.core.truth_((function (){var or__26906__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__26906__auto__)){
return or__26906__auto__;
} else {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__43077__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__43077__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__43077__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__43077__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__43078 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__43078,(0),null);
var fn_name = cljs.core.nth.call(null,vec__43078,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__43078,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__43078,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__43078,(4),null);
var arity = cljs.core.nth.call(null,vec__43078,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__26894__auto__ = protocol_ns;
if(cljs.core.truth_(and__26894__auto__)){
return cljs.core.not.call(null,(function (){var and__26894__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str((function (){var or__26906__auto__ = protocol_part;
if(cljs.core.truth_(or__26906__auto__)){
return or__26906__auto__;
} else {
return fn_part;
...
var o__40691__auto__ = f;
return goog.object.get(o__40691__auto__,"getBasis").call(o__40691__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__26894__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__26894__auto__)){
...
}catch (e43083){var e__40716__auto__ = e43083;
...
var G__43084 = goog.object.get(obj,cljs.core.first.call(null,path));
var G__43085 = cljs.core.rest.call(null,path);
obj = G__43084;
path = G__43085;
continue;
} else {
...
var partition_bits = (function (){var or__26906__auto__ = goog.object.get(obj,partition_key);
if(cljs.core.truth_(or__26906__auto__)){
return or__26906__auto__;
} else {
return (0);
...
return (function (accum,p__43090){
var vec__43091 = p__43090;
var bit = cljs.core.nth.call(null,vec__43091,(0),null);
var protocol = cljs.core.nth.call(null,vec__43091,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__43094){
var vec__43098 = p__43094;
var ns = cljs.core.nth.call(null,vec__43098,(0),null);
var name = cljs.core.nth.call(null,vec__43098,(1),null);
var selector = cljs.core.nth.call(null,vec__43098,(2),null);
...
return (function (p__43106){
var vec__43107 = p__43106;
var munged_name = cljs.core.nth.call(null,vec__43107,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__43107,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__43107,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__43101_SHARP_){
return goog.object.get(obj,cljs.core.first.call(null,p1__43101_SHARP_));
});})(name,sorted_matches,vec__43107,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1506566569999