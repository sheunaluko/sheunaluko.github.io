...
var reader = (function (){var or__26906__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__26906__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__26906__auto__)){
return or__26906__auto__;
} else {
return (128);
...
var file = cljs.core.get.call(null,map__43911__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__43911__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__43911__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e43910){var _e = e43910;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___43913 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___43913)){
var seen_errors_43914 = temp__4655__auto___43913;
if(cljs.core.truth_(seen_errors_43914.has(self))){
} else {
seen_errors_43914.add(self);

var temp__4657__auto___43915 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___43915)){
var sense_43916 = temp__4657__auto___43915;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_43916)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1506566572265