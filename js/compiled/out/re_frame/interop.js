...
return [cljs.core.str((function (){var pred__28747 = cljs.core.instance_QMARK_;
var expr__28748 = reactive_val;
if(cljs.core.truth_(pred__28747.call(null,reagent.ratom.RAtom,expr__28748))){
return "ra";
} else {
if(cljs.core.truth_(pred__28747.call(null,reagent.ratom.RCursor,expr__28748))){
return "rc";
} else {
if(cljs.core.truth_(pred__28747.call(null,reagent.ratom.Reaction,expr__28748))){
return "rx";
} else {
if(cljs.core.truth_(pred__28747.call(null,reagent.ratom.Track,expr__28748))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1506566542853