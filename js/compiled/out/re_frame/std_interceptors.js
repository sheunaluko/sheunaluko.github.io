...
var vec__34814_34817 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_34818 = cljs.core.nth.call(null,vec__34814_34817,(0),null);
var only_after_34819 = cljs.core.nth.call(null,vec__34814_34817,(1),null);
var db_changed_QMARK__34820 = (cljs.core.some_QMARK_.call(null,only_before_34818)) || (cljs.core.some_QMARK_.call(null,only_after_34819));
if(db_changed_QMARK__34820){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_34818);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_34819);
...
var map__34827 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var event = cljs.core.get.call(null,map__34827__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__34835 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__34835__$1;
var event = cljs.core.get.call(null,map__34835__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__27981__auto___34838 = arguments.length;
var i__27982__auto___34839 = (0);
while(true){
if((i__27982__auto___34839 < len__27981__auto___34838)){
args__27988__auto__.push((arguments[i__27982__auto___34839]));

var G__34840 = (i__27982__auto___34839 + (1));
i__27982__auto___34839 = G__34840;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__27989__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq34837){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq34837));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__26906__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__27988__auto__ = [];
var len__27981__auto___34846 = arguments.length;
var i__27982__auto___34847 = (0);
while(true){
if((i__27982__auto___34847 < len__27981__auto___34846)){
args__27988__auto__.push((arguments[i__27982__auto___34847]));

var G__34848 = (i__27982__auto___34847 + (1));
i__27982__auto___34847 = G__34848;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__27989__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__34841_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__34842_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__34842_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq34843){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__34844,G__34845,seq34843__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1506566553240