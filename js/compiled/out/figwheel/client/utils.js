...
return (new CustomEvent(event_name,(function (){var obj37013 = {"detail":data};
return obj37013;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__26894__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__26894__auto__)){
var and__26894__auto____$1 = (window["CustomEvent"]);
...
var args37018 = [];
var len__27981__auto___37024 = arguments.length;
var i__27982__auto___37025 = (0);
while(true){
if((i__27982__auto___37025 < len__27981__auto___37024)){
args37018.push((arguments[i__27982__auto___37025]));

var G__37026 = (i__27982__auto___37025 + (1));
i__27982__auto___37025 = G__37026;
continue;
} else {
}
break;
...
var f = (function (){var pred__37021 = cljs.core._EQ_;
var expr__37022 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__37021.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__37022))){
return ((function (pred__37021,expr__37022){
return (function (p1__37014_SHARP_){
return console.warn(p1__37014_SHARP_);
});
;})(pred__37021,expr__37022))
} else {
if(cljs.core.truth_(pred__37021.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__37022))){
return ((function (pred__37021,expr__37022){
return (function (p1__37015_SHARP_){
return console.debug(p1__37015_SHARP_);
});
;})(pred__37021,expr__37022))
} else {
if(cljs.core.truth_(pred__37021.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__37022))){
return ((function (pred__37021,expr__37022){
return (function (p1__37016_SHARP_){
return console.error(p1__37016_SHARP_);
});
;})(pred__37021,expr__37022))
} else {
return ((function (pred__37021,expr__37022){
return (function (p1__37017_SHARP_){
return console.log(p1__37017_SHARP_);
});
;})(pred__37021,expr__37022))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__37028){
...
var opts = map__37031__$1;
var eval_fn = cljs.core.get.call(null,map__37031__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__37033_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__37035,(0),null);
...
var args37038 = [];
var len__27981__auto___37041 = arguments.length;
var i__27982__auto___37042 = (0);
while(true){
if((i__27982__auto___37042 < len__27981__auto___37041)){
args37038.push((arguments[i__27982__auto___37042]));

var G__37043 = (i__27982__auto___37042 + (1));
i__27982__auto___37042 = G__37043;
continue;
} else {
}
break;
...
if(cljs.core.truth_((function (){var and__26894__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1506566558100