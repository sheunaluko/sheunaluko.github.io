...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__27512__auto__,writer__27513__auto__,opt__27514__auto__){
return cljs.core._write.call(null,writer__27513__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__28551 = o;
(G__28551[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__28552__delegate = function (args){
...
while (G__28553__i < G__28553__a.length) {G__28553__a[G__28553__i] = arguments[G__28553__i + 0]; ++G__28553__i;}
  args = new cljs.core.IndexedSeq(G__28553__a,0);
} 
return G__28552__delegate.call(this,args);};
G__28552.cljs$lang$maxFixedArity = 0;
G__28552.cljs$lang$applyTo = (function (arglist__28554){
var args = cljs.core.seq(arglist__28554);
return G__28552__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__26894__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__26894__auto__){
var and__26894__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__28560 = jsprops;
(G__28560["defaultValue"] = value);

(G__28560["onChange"] = ((function (G__28560,v,value,on_change){
return (function (p1__28557_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__28557_SHARP_);
});})(G__28560,v,value,on_change))
);

(G__28560["ref"] = ((function (G__28560,v,value,on_change){
return (function (p1__28558_SHARP_){
return (this$["cljsInputElement"] = p1__28558_SHARP_);
});})(G__28560,v,value,on_change))
);
...
var vec__28567 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__28567,(0),null);
var id = cljs.core.nth.call(null,vec__28567,(1),null);
var class$ = cljs.core.nth.call(null,vec__28567,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___28572 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___28572 == null)){
} else {
var key_28573 = temp__4661__auto___28572;
(jsprops["key"] = key_28573);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__28575 = (new reagent.impl.template.NativeWrapper());
(G__28575["name"] = c);
...
var len__27981__auto___28581 = arguments.length;
var i__27982__auto___28582 = (0);
while(true){
if((i__27982__auto___28582 < len__27981__auto___28581)){
args__27988__auto__.push((arguments[i__27982__auto___28582]));

var G__28583 = (i__27982__auto___28582 + (1));
i__27982__auto___28582 = G__28583;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__27989__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq28579){
var G__28580 = cljs.core.first.call(null,seq28579);
var seq28579__$1 = cljs.core.next.call(null,seq28579);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__28580,seq28579__$1);
});
...
break;
default:
var G__28587 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__28587;
continue;
...
var n__27821__auto___28590 = a.length;
var i_28591 = (0);
while(true){
if((i_28591 < n__27821__auto___28590)){
(a[i_28591] = reagent.impl.template.as_element.call(null,(a[i_28591])));
...
var a = cljs.core.into_array.call(null,s);
var n__27821__auto___28593 = a.length;
var i_28594 = (0);
while(true){
if((i_28594 < n__27821__auto___28593)){
var val_28595 = (a[i_28594]);
if((cljs.core.vector_QMARK_.call(null,val_28595)) && ((reagent.impl.template.key_from_vec.call(null,val_28595) == null))){
(o["no-key"] = true);
} else {
}

(a[i_28594] = reagent.impl.template.as_element.call(null,val_28595));

var G__28596 = (i_28594 + (1));
i_28594 = G__28596;
continue;
} else {
}
...
var ctx = ({});
var vec__28600 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__28600,(0),null);
var derefed = cljs.core.nth.call(null,vec__28600,(1),null);
...
var G__28604 = (cljs.core.count.call(null,argv) - first_child);
switch (G__28604) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__28604){
...
//# sourceMappingURL=template.js.map?rel=1506566542435